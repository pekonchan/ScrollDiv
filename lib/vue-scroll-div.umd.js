(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-scroll-div"] = factory();
	else
		root["vue-scroll-div"] = factory();
...
// load the styles
var content = __webpack_require__("161c");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("495fd31f", content, true, {"sourceMap":false,"shadowMode":false});
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"09af78e4-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./packages/src/index.vue?vue&type=template&id=3b0508ec&
var render = function () {
var _obj, _obj$1;
var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{ref:"scrollDiv",staticClass:"scroll-div",class:( _obj = {'is-scroll-native': _vm.isSurportNative, 'is-native-div': !_vm.needCustom}, _obj[_vm.viewClass] = !_vm.needCustom, _obj ),style:(_vm.viewStyle)},[(_vm.needCustom)?_c('div',{ref:"scrollDivView",staticClass:"scroll-div-view",class:( _obj$1 = {}, _obj$1[_vm.viewClass] = _vm.needCustom, _obj$1 ),style:(_vm.divStyle)},[_vm._t("default"),(!_vm.needOptimize)?_c('div',{staticClass:"scroll-view__padding",style:({height: _vm.paddingBottom})}):_vm._e()],2):_vm._e(),(_vm.needCustom && _vm.needYBar)?_c('div',{ref:"scrollY",staticClass:"scroll-div-y",style:(_vm.yScrollWrapStyle)},[_c('div',{ref:"scrollYBar",staticClass:"scroll-div-y-bar",class:{'is-show': _vm.showScrollY},style:(_vm.yBarStyle)})]):_vm._e(),(_vm.needCustom && _vm.needXBar)?_c('div',{ref:"scrollX",staticClass:"scroll-div-x",style:(_vm.xScrollWrapStyle)},[_c('div',{ref:"scrollXBar",staticClass:"scroll-div-x-bar",class:{'is-show': _vm.showScrollX},style:(_vm.xBarStyle)})]):_vm._e(),(!_vm.needCustom)?_vm._t("default"):_vm._e()],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./packages/src/index.vue?vue&type=template&id=3b0508ec&
...
/* harmony default export */ var srcvue_type_script_lang_js_ = ({
  ...
  data: function data() {
    var disabledOptimize = navigator.userAgent.indexOf('Firefox') > -1 || "ActiveXObject" in window || window.navigator.userAgent.indexOf("MSIE") > -1;
    ++utils.zIndex;
    var level = utils.zIndex;
    return {
      needCustom: false,
      ...
      gutterWidth: 0,
      paddingBottom: 0,
      disabledOptimize: disabledOptimize,
      calcIndex: level,
      // 自动计算的zIndex
      needYBar: true,
      // 滚动条常驻时是否需要渲染垂直滚动条
  ...
  computed: {
    needOptimize: function needOptimize() {
    ...
    divStyle: function divStyle() {
      var style = {};
      this.height ? style.height = "calc(".concat(this.viewHeight, " + ").concat(this.gutterWidth, "px)") : style['overflow-x'] = 'hidden';
      style.width = "calc(".concat(this.width ? this.viewWidth : '100%', " + ").concat(this.gutterWidth, "px)");
    ...
    yBarStyle: function yBarStyle() {
      return this.createBarStyle(true);
    },
    xBarStyle: function xBarStyle() {
      return this.createBarStyle();
    },
    yScrollWrapStyle: function yScrollWrapStyle() {
      var zIndex = this.zIndex,
          calcIndex = this.calcIndex,
          size = this.size;
      var style = {
        zIndex: calcIndex
      };
      ...
      if (size) {
        var sizeValue = this.formatValue(size);
    ...
    xScrollWrapStyle: function xScrollWrapStyle() {
      var zIndex = this.zIndex,
          calcIndex = this.calcIndex,
          size = this.size;
      var style = {
  ...
  methods: {
    ...
    calcPaddingBottom: function calcPaddingBottom() {
    ...
    handleScroll: function handleScroll(el) {
      ...
      var scroll, showScroll, scrollArea, clientArea, timer, scrollBar, isVertical, transform;
      ...
      var scrollAreaValue = this.customScrollContainer[scrollArea];
      var clientAreaValue = this.customScrollContainer[clientArea];
      var scrollValue = this.customScrollContainer[scroll];
      this[showScroll] = true;
      this[timer] && clearTimeout(this[timer]);
      this.calcSize(isVertical);
      var distance = scrollValue * clientAreaValue / scrollAreaValue;
      this[scrollBar] && (this[scrollBar].style.transform = "".concat(transform, "(").concat(distance, "px)"));
    ...
    clickStart: function clickStart(el) {
      var e = el || event;
      var target = e.target || e.srcElement;
    ...
    moveScrollYBar: function moveScrollYBar(el) {
      this.moveScrollBar(el, 'pageY', 'startY', 'scrollHeight', 'clientHeight', 'distanceY', 'scrollTop');
    },
    moveScrollXBar: function moveScrollXBar(el) {
      this.moveScrollBar(el, 'pageX', 'startX', 'scrollWidth', 'clientWidth', 'distanceX', 'scrollLeft');
    },
    moveScrollBar: function moveScrollBar(el, pageOffset, start, scrollArea, clientArea, distance, scroll) {
      var e = el || event;
      var delta = e[pageOffset] - this[start];
      var scrollAreaValue = this.customScrollContainer[scrollArea];
      var clientAreaValue = this.customScrollContainer[clientArea];
      var change = scrollAreaValue * delta / clientAreaValue;
    ...
    hoverSrollYBar: function hoverSrollYBar() {
      this.hoverScrollBar('scrollHeight', 'clientHeight', 'showScrollY', 'scrollYBar', 'scrollY', 'height');
    },
    hoverSrollXBar: function hoverSrollXBar() {
      this.hoverScrollBar('scrollWidth', 'clientWidth', 'showScrollX', 'scrollXBar', 'scrollX', 'width');
    },
    hoverScrollBar: function hoverScrollBar(scrollArea, clientArea, showScroll, scrollBar, scrollBarArea, style) {
      var sA = this.customScrollContainer[scrollArea];
      var cA = this.customScrollContainer[clientArea];
    ...
    hoverOutSroll: function hoverOutSroll(el) {
      var e = el || event;
      var target = e.target || e.srcElement;
    ...
    getOriginScrollWidth: function getOriginScrollWidth() {
    ...
    checkWebkit: function checkWebkit() {
    ...
    calcSize: function calcSize(isHeight) {
      var scrollBar, sizeKey, clientArea, scrollArea;
    ...
    scrollTo: function scrollTo(yPosition, xPosition) {
    ...
    updateScrollBar: function updateScrollBar() {
      ...
      var _this$customScrollCon = this.customScrollContainer,
          clientHeight = _this$customScrollCon.clientHeight,
          clientWidth = _this$customScrollCon.clientWidth,
          scrollHeight = _this$customScrollCon.scrollHeight,
          scrollWidth = _this$customScrollCon.scrollWidth;
      var showScrollY = scrollHeight > clientHeight;
      var showScrollX = scrollWidth > clientWidth;
      this.needYBar = showScrollY;
      this.needXBar = showScrollX; // 从有滚动条变成无时，解绑原本的监听事件（除初始化时，那时候还没绑定监听，但是还是会执行该段代码，因为默认滚动条是展示的）
      ...
      this.$nextTick(function () {
        _this2.scrollY = _this2.$refs.scrollY;
        _this2.scrollX = _this2.$refs.scrollX;
        _this2.scrollYBar = _this2.$refs.scrollYBar;
        _this2.scrollXBar = _this2.$refs.scrollXBar;

        if (showScrollY) {
          _this2.scrollYBar.addEventListener('mousedown', _this2.clickStart);

          _this2.scrollYBar.style.opacity = showScrollY ? 1 : 0; // 滚动条的默认样式是透明的

          _this2.calcSize(true);
        }

        if (showScrollX) {
          _this2.scrollXBar.addEventListener('mousedown', _this2.clickStart);

          _this2.scrollXBar.style.opacity = showScrollX ? 1 : 0;

          _this2.calcSize();
        }
      });
    },
    createBarStyle: function createBarStyle(isYScroll) {
      var style = _objectSpread2({}, this.barStyle);

      if (this.size) {
        var sizeValue = this.formatValue(this.size);
        isYScroll ? style.width = sizeValue : style.height = sizeValue;
        style.borderRadius = sizeValue;
      }

      if (this.offset) {
        var offsetValue = this.formatValue(this.offset);
...
// EXTERNAL MODULE: ./packages/src/index.vue?vue&type=style&index=0&lang=scss&
var srcvue_type_style_index_0_lang_scss_ = __webpack_require__("24e8");
...
src.install = function (Vue, opts) {
  var _loop = function _loop(key) {
    if (Object.prototype.hasOwnProperty.call(opts, key)) {
      src.props[key].default = function () {
        return opts[key];
      };
    }
  };
