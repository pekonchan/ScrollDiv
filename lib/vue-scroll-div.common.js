...
/* harmony default export */ var srcvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    handleScroll: function handleScroll(el) {
      ...
      var scrollAreaValue = this.scrollContainer[scrollArea];
      var clientAreaValue = this.scrollContainer[clientArea];
      var scrollValue = this.scrollContainer[scroll];
    ...
    hoverScrollBar: function hoverScrollBar(scrollArea, clientArea, showScroll, scrollBar, scrollBarArea, style) {
      var sA = this.scrollContainer[scrollArea];
      var cA = this.scrollContainer[clientArea];
