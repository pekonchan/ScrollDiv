...
/* harmony default export */ var srcvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    divStyle: function divStyle() {
      var style = {};
      this.height ? style.height = "calc(100% + ".concat(this.gutterWidth, "px)") : style['overflow-x'] = 'hidden';
      style.width = "calc(100% + ".concat(this.gutterWidth, "px)");
